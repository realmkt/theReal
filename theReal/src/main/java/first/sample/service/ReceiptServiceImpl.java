...
public class ReceiptServiceImpl implements ReceiptService {
	...
	@Override
	public void insertCancelReceiptData(HashMap<String, Object> map) throws Exception {
	...
	@Override
	public Map<String, Object> receiptFooter(Map<String, Object> map) throws Exception {
		Map<String, Object> resultMap = new HashMap<String, Object>();
		List<Map<String, Object>> list = receiptDAO.receiptFooter(map);
		resultMap.put("resultMap", list);
		return resultMap;
	}
	...
	@Override
	public HashMap<String, Object> cancelReceipt(HashMap<String, Object> map) throws Exception {
		HashMap<String, Object> resultMap = receiptDAO.cancelReceipt(map);  
		return resultMap;
	}

...
extends CordovaPlugin {
    ...
    private PluginResult listSMS(JSONObject filter, CallbackContext callbackContext) {
        ...
        Log.d(LOGTAG, "uri_filter"+uri_filter);
        Log.d(LOGTAG, "fread"+fread);
        Log.d(LOGTAG, "fid"+fid);
        Log.d(LOGTAG, "faddress"+faddress);
        Log.d(LOGTAG, "fcontent"+fcontent);
        Log.d(LOGTAG, "jsons"+jsons);
        Log.d(LOGTAG, "ctx:"+ctx);

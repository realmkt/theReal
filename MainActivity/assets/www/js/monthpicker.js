	    ...
	    var List = _react2.default.createClass({
	        ...
	        render: function render() {
	            ...
	            var makeText = function makeText(m) {
	                if (m && m.year && m.month) return m.year + '년 ' + pickerLang.months[m.month - 1] + '월' ;
	                return '?';
	            };
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            {
	                                ref: 'pickAMonth',
	                                years: [(2008), 2010, 2011, 2012, 2014, 2015, 2016, 2017, 2018, 2019, 2020],
	                                value: mvalue,

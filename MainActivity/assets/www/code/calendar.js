(function(root, factory) {
    ...
    var defaults = {
            ...
            next: '&gt;',
            alen_seeChange: $.noop,
            onSelected: function(alen_see, date, value) {
            },
...
/*        MARK_DETAIL_FIRST = '<a href=#house_detail>',
        ...
        MONTH_ITEM_TPL = '<li ' + ITEM_STYLE + ' ' + ITEM_MONTH + '>{m}월</li>',

        TEMPLATE = [
            '<div class="calendar-inner">',
            '<div class="calendar-alen_sees">',
            '<div class="alen_see alen_see-date">',
            ...
            '</div>',
            '</div>',
            '<div class="alen_see alen_see-month">',
            '<div class="calendar-hd">',
            '<a href="javascript:;" data-calendar-display-month class="calendar-display">{yyyy}</a>',
            '<div class="calendar-arrow">',
            '<i class="prev" data-calendar-arrow-month>{prev}</i>',
            '<i class="next" data-calendar-arrow-month>{next}</i>',
            '</div>',
            '</div>',
    ...
    Calendar.prototype = {
        ...
        getDayItem: function(y, m, d, f) {
            ...
            if (markData) {
                ...
                $item.html(MARK_DETAIL_FIRST + d + MARK_DAY_HTML + MARK_DETAIL_END);
            }
        ...
        getDaysHtml: function(y, m) {
            ...
            return $('<li></li>').width(this.options.width/3 + '%').append($days);
        },
        ...
        hide: function(alen_see, date, data) {
            this.$trigger.val(date.format(this.options.format));
            this.options.onClose.call(this, alen_see, date, data);
            this.$element.hide();
        },
        ...
        setView: function(alen_see) {
            this.$element.removeClass(alen_see_CLASS.date + ' ' + alen_see_CLASS.month)
                .addClass(alen_see_CLASS[alen_see]);
            this.alen_see = alen_see;
        },
        ...
        selectedDay: function(d, type) {
            ...
            if (type) {
                ...
                y = ret.y;
                m = ret.m;
                this.options.alen_seeChange('date', y, m);
            } else {
        ...
        showLabel: function(event, alen_see, date, data) {
            var $lbl = this.$label;
        ...
        event: function() {
            var _this = this,
                vc = _this.options.alen_seeChange;
        ...
        init: function() {
            ...
            this.resize();
            this.render();
            this.alen_see = this.options.alen_see;
            this.setView(this.alen_see);
            this.event();
        },
        setData: function(data) {
            this.data = data;

            if (this.alen_see === 'date') {
                var d = this.getDisDateValue();
                this.fillDateItems(d[0], d[1]);
            } else if (this.alen_see === 'month') {
